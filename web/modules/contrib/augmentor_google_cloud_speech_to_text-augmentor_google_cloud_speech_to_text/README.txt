...
The Augmentor Google Cloud Speech-to-Text is a submodule of Augmentor. 
It provides an implementation of multiple Augmentor plugins to allow Augmentor 
to interface with Google Cloud's Speech-to-Text REST APIs so you can send audio 
and receive a text transcription.
